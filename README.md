...
- AI Studio account + API key
- Python 3.12+
- Google's Agent Development Kit (ADK)
- Required libraries (see individual notebooks)

## 🛠️ Technologies & Frameworks

- **LLM Framework:** Google Gemini + Agent Development Kit (ADK)
- **Language:** Python 3.12
- **Key Concepts:** Multi-agent systems, Agent orchestration, Model Context Protocol, Tool integration
- **Platforms:** Kaggle Notebooks, Google AI Studio
